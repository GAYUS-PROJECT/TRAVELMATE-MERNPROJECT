      ...
      <div class="md:px-36 px-8 md:py-28 py-5">
        <div class="flex lg:flex-row flex-col grid-cols-2 gap-10">
          <div class="flex flex-col gap-5 justify-center p-5">
            ...
            <p class="mt-4">
            India stuns with its vibrant tapestry - ancient forts, colorful festivals, diverse cultures.  Experience the warmth of its people, the echo of its history, and the spirit of a nation on the rise.  Unveil the jewel of the East - explore India!
            </p>
